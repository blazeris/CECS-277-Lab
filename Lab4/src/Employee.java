...
public abstract class Employee implements EmployeeInfo, Comparable{
    ...
    /**
     * Compares this employee to another employee by ID
     * @param o Other object compared to
     * @return Numerical comparison value between this and other object
     */
    @Override
    public int compareTo(Object o){
        Employee emp = (Employee) o;
        return ID.compareTo(emp.getID());
    }
}
